...
#pragma warning restore 0649
        ...
        public void Initialize(Transform[] activeCameras, int nrOfVehicles, VehiclePool vehiclePool, TrafficOptions trafficOptions)
        {
            ...
            for (int i = 0; i < nrOfVehicles; i++)
            {
                ...
                if (vehicle.trailer != null)
                {
                    ...
                    trailerDrag[i] = trailer.rb.linearDamping;
        ...
        private void NewVehicleAdded(int vehicleIndex)
        {
            ...
            {
                trailerRigidbody[vehicleIndex].linearVelocity = vehicleRigidbody[vehicleIndex].linearVelocity;
            }
        ...
        private void FixedUpdate()
        {
            ...
            for (int i = 0; i < nrOfVehicles; i++)
            {
                ...
                {
                    trailerVelocity[i] = trailerRigidbody[i].linearVelocity;
        ...
        private void Update()
        {
            ...
            if (drawBodyForces)
            {
                for (int i = 0; i < nrOfVehicles; i++)
                {
                    ...
                    {
                        Vector3 localVelocity = trailerRigidbody[i].transform.InverseTransformVector(trailerRigidbody[i].linearVelocity);
                        ...
                        Debug.DrawRay(trailerRigidbody[i].transform.TransformPoint(trailerRigidbody[i].centerOfMass), trailerRigidbody[i].linearVelocity, Color.red);
                    }
                }
