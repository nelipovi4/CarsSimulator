...
public class RCC_Settings : ScriptableObject {
    ...
    public string RCCLayer = "RCC_Vehicle";     //  Layer of the vehicle.
    ...
    public string PropLayer = "RCC_Prop";       //  Prop part's layer.

    public PhysicsMaterial colliderMaterial;     //  Main body collider material.
